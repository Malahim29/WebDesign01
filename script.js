$(document).ready(function () {
    ...
    function fetchBooks() {
        $.ajax({
            url: `http://localhost:5046/api/Books`, // Use the port variable here
            method: 'GET',
            ...
            var html = `
                <tr>
                    ...
                    <td class="table-actions">
                        <button class="edit-button" data-id="${book.id}"><i class="fas fa-pencil-alt"></i></button>
                        <button class="delete-button" data-id="${book.id}"><i class="fas fa-trash-alt"></i></button>
                    </td>
                </tr>`;
    ...
    $('#createBookForm').submit(function (event) {
        ...
        if (isUpdating) {
            $.ajax({
                type: 'PUT',
                url: `https://localhost:${port}/api/Books/${currentBookId}`, // Use the port variable here
            ...
            $.ajax({
                type: 'POST',
                url: `https://localhost:${port}/api/Books`, // Use the port variable here
                data: JSON.stringify(bookData),
                contentType: 'application/json',
                success: function (response) {
    ...
    function handleDeleteButtonClick() {
        ...
        $.ajax({
            type: 'DELETE',
            url: `https://localhost:${port}/api/Books/${bookId}`, 
            success: function (response) {
